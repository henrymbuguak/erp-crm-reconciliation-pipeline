...
- Two deliberately divergent exports of the same underlying data: an ERP-style flat CSV (legacy field names) and a CRM-style nested JSON (camelCase field names) -- mirroring how a real SAP/Salesforce-style hybrid legacy stack disagrees with itself.
...
!!! note "Part of a larger project"
    ...
    Integration & Data Cleaning Pipeline**: an ingestion and cleaning engine
